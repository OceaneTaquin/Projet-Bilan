...
<template>
  <header>
    <img
      @click="scrollToTop"
      src="../assets/images/fleche-vers-le-haut.png"
      alt="Image Retour vers le Haut"
      class="return-top-photo"
    />
  ...
  <div class="logo-container">
    <img src="../assets/images/Logo Océane.png" alt="Mon Logo" class="logo" />
  </div>
</template>
